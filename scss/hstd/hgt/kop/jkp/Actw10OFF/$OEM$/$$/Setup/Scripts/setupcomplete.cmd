...
if %winbuild% GEQ 9600 (
  ...
  if %External% EQU 0 WMIC /NAMESPACE:\\root\Microsoft\Windows\Defender PATH MSFT_MpPreference call Add ExclusionPath=%_Hook% Force=True %_Nul3%
)
call :StopService sppsvc
...
if %loc_off19% EQU 0 if %loc_off16% EQU 0 if %loc_off15% EQU 0 (exit /b)
set Off1ce=1
set _sC2R=sppoff
set _fC2R=ReturnSPP
...
:win7off
rem nothing installed
if %loc_off19% EQU 0 if %loc_off16% EQU 0 if %loc_off15% EQU 0 if %loc_off14% EQU 0 (exit /b)
set Off1ce=1
set _sC2R=win7off
